...
DATABASE_URL=postgresql+psycopg://reconai:reconai@localhost:5432/reconai uv run alembic revision --autogenerate -m "create reconciliation cases"
...
- `backend/migrations/README` (new): Command-generated Alembic scaffold note for L2.
